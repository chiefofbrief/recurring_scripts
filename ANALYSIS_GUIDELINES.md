...
2. **Macroeconomics:** Monitor market conditions and identify instability.
   ...
   **Boom/bust anatomy:** At the market level, watch for reflexive feedback loops where inflated stock prices accelerate an underlying trend, which enhances expectations and inflates prices further—until outcomes fail to sustain expectations. A misconception is always involved: in the conglomerate boom, investors valued per-share earnings identically regardless of how they were achieved; in the technology boom, stocks were valued at multiples of revenue rather than earnings, and growth was financed by selling stock rather than following sound business plans. In each case the misconception was reinforced by genuinely improving fundamentals (earnings and revenue growth accelerated)—this is the fertile fallacy, where participants fail to recognize that the fundamentals they are cheering only look healthy because the market is currently willing to fund them. Eventually a turning point is reached, and once stocks decline the trend becomes self-reinforcing in the opposite direction: excesses concealed while prices were rising begin to surface, and the same mechanism that created the rise ensures an abrupt, asymmetric collapse. Reflexivity may or may not give rise to a full boom/bust sequence, and the process may be aborted at any time—not everything is a five-alarm fire.
...
3. **AI Ecosystem:** Identify stocks with exposure to AI value chain layers.

   The AI ecosystem spans from chip fabrication to end-user applications. Each layer has distinct dynamics:

   - **Compute & Chips:** Foundries (TSMC), semiconductors (Nvidia, AMD), and custom silicon (cloud provider chips). Watch for: foundry leverage, custom chip development reducing Nvidia dependence, rapid depreciation as new chips outperform old.
   - **Infrastructure:** Cloud hyperscalers, data centers, power/utilities. Big Tech is absorbing demand risk across the supply chain, effectively subsidizing the ecosystem. Data center developers have attractive risk profiles with long-term leases.
   - **Models & Tools:** Foundation models (OpenAI, Anthropic, Google, Meta, xAI) consolidating to ~5 finalists. Low switching costs between models; higher switching costs in orchestration/agent frameworks. Expensive to build, uncertain returns.
